...
ax2 = ax1.twinx()
x,y1,y2,y3,y4,y5,y6,y7,y8,y9,y10,y11,y12= np.loadtxt('02aug2017_chambdata.csv',unpack=True, delimiter=',',skiprows=1)
...
ax1.set_ylim([25,40]) 
ax1.set_xlim([0,131.75])

xref1, yref1 = [0, 131.75], [30, 30]
xref2, yref2 = [0, 131.75], [25, 25]
