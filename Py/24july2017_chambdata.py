...
ax2 = ax1.twinx()
x,y1,y2,y3,y4,y5,y6,y7,y8,y9,y10,y11,y12,y13,y14,y15,y16,y17= np.loadtxt('24july2017_chambdata.csv',unpack=True, delimiter=',',skiprows=1)
...
ax1.plot(x,y12,label="T1")
ax1.plot(x,y13,label="T2")
