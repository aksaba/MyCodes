...
ax2 = ax1.twinx()
x,y1,y2,y3,y4,y5,y6,y7,y8,y9,y10,y11,y12,y13,y14,y15,y16,y17= np.loadtxt('25july2017_chambdata.csv',unpack=True, delimiter=',',skiprows=1)
...
ax1.plot(x,y12,label="T1_Temp")
ax1.plot(x,y13,label="T2_Temp")
ax1.plot(x,y14,label="HTU21D_1_Temp")
ax2.plot(x,y15,'r--',label="HTU21D_1_%RH")
ax1.plot(x,y16,label="HTU21D_2_Temp")
ax2.plot(x,y17,'b--',label="HTU21D_2_%RH")

ax1.set_ylim([28,38]) 
ax1.set_xlim([0,100])

xref1, yref1 = [0, 100], [30, 30]
xref2, yref2 = [0, 100], [40, 40]
